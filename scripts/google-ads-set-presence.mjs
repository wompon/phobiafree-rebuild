/**
 * Set campaign 24066888224 geo targeting to PRESENCE (not presence-or-interest).
 * Usage: node scripts/google-ads-set-presence.mjs
 */
...
console.log('DONE — geo targeting set to PRESENCE only (people actually in the US).');
